...
API_ID = int(environ.get('API_ID', '21134445))  # Telegram API ID
API_HASH = environ.get('API_HASH', '231c18ea7273824491d6bf05425ab74e')  # Telegram API Hash
BOT_TOKEN = environ.get('BOT_TOKEN', '')  # Telegram Bot Token

# 👑, Channels & Logs
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1003146170668'))  # File storage channel
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1003146170668'))  # General log channel
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1003146170668'))  # Premium user actions log
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1003146170668'))  # Verified user actions log
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003146170668"))
...
DB_URL = environ.get('DATABASE_URI', "mongodb+srv://susantxbotz:vGmf4pFy1MEijuZF@cluster0.viyjnvi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB connection URI
DB_NAME = environ.get('DATABASE_NAME', "cluster0")  # MongoDB database name

# 📸 all Media (Images)
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/5si6pg.jpg')  # QR Code image
...
PICS = environ.get('PICS', 'https://files.catbox.moe/5m421d.jpg')  # Default info image
FILE_PIC = environ.get('FILE_PIC', 'https://files.catbox.moe/v192j5.jpg') # file image 
